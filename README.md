...
For more information about the MPTA visit [mpta-gw.github.io/](https://mpta-gw.github.io/)

## About this repository

Data used for this work can be found in `data`, scripts can be found in `snr`.... 
