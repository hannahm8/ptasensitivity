...
The average S/N for a PTA with total timespan $T$ is given by
\begin{equation}
...
\label{eqn:hd}
\end{eqnarray}
for pulsars $I$ and $J$ separated by angle $\zeta$.
...
\end{equation}
where $\ARedI$ and $\gammaRedI$ are the amplitude and slope of the spin noise power law for the $I$th pulsar and ${\rm yr}$ is the number of seconds in a year. 
...
\label{eqn:PIGWWR}
\end{eqnarray}
which includes the SGWB, white noise, spin noise, and jitter noise.
