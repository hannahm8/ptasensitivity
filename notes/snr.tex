...
We calculate the average SNR for a given PTA and a predicted SGWB signal following the method in~\cite{SiemensEtAl:2013}. 
...
Throughout this work we assume $a=-2/3$ consistent with a stochastic background from circular massive black hole binaries and $A = 2 \times 10^{-15}$ consistent with recent speculative hints of detection~\cite{GoncharovEtAlPPTA:2021,NANOGrav12.5GWB:2020}.
...
The Hellings and Downs coefficients $\chi_{IJ}$ describe the expected angular correlation produced by the SGWB signal in pairs of pulsars and is given by % [ref]
\begin{eqnarray}
\chiIJhd &=& \frac{1}{2} 
