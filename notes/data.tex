...
Assuming a SGWB signal with $A = 2\times 10^{-15}$ and $\alpha = -2/3$, we can estimate the predicted average S/N for MeerTime from Eqn.~\ref{eqn:snrPIPJPg}. 
After a timespan of $T=10\,{\rm yrs}$, the average S/N for the current obseravation stategy is $12.3$.
