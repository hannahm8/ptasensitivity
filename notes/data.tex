...
Jitter noise measurements from% \cite{ParthasarathyEtAl:2021}.
}
\end{table}
...
After a timespan of $T=10\,{\rm yrs}$, the average SNR for the current obseravation stategy is $\approx 11.0$. \textbf{check number}. 
