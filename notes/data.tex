...
From observations to date, we have an anticipated $\sigma_I$ and the integration time (for a single pulsar observation) required to achieve it for each pulsar and $\sigma_I$ scales with observation $T_{{\rm obs},I}$ time like 
\begin{equation}
...
After a timespan of $T=10\,{\rm yrs}$, the average SNR is $\approx 11.0$.
Can we improve this by reallocating the observing time? 
