...
Similarly, some of the pulsars have existing jitter noise estimates. 
Table~\ref{tab:reNoiseJitterNoise} also shows jitter noise measurements for $13$ MeerTime pulsars from~\cite{ParthasarathyEtAl:2021}.
